...
const routes = [
  ...
  { path: "/membership.html", html: membershipPage() },
...
const searchIndex = [
  ...
  { title: "Membership", url: "/membership.html", excerpt: "Your journey from guest to Steward at Heralds — membership process and church leadership.", tag: "Page" },
