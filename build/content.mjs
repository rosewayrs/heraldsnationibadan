...
export const home = {
  ...
  experience: {
    ...
    cards: [
      ...
      },
      {
        ...
        cta: { label: "Join The Family", href: "/membership.html" },
        style: "accent",
      },
    ],
  },
  ...
  events: {
    ...
    body: "Mark your calendar — here's what's coming up at Heralds.",
...
export const about = {
  ...
  membership: {
    ...
    cta: { label: "Learn About Membership", href: "/membership.html" },
  },
};
...
// ---------------------------------------------------------------------------
export const events = {
  // Real upcoming events, from flyers supplied by the church. Ordered
  // chronologically by start date — keep it that way as events are added.
  upcoming: [
    {
      slug: "summer-camp-2026",
      badge: "Young Heralds",
      title: "Young Heralds' Summer Camp 2026 — Ektrephō",
      excerpt: "A 3-day camp for children and teens (ages 5–19) built around God's Word, soft skills, fun games and prayer — themed \"Ektrephō: To Nourish Up To Maturity.\"",
      dateLabel: "Friday, August 28 – Sunday, August 30, 2026",
      timeLabel: "Fri & Sat 9:00AM–5:00PM, Sun 8:00AM",
      location: "The Heraldome, 20 IBB Avenue, Opp. Ibom E-Library, Uyo, Akwa Ibom State",
      image: "/images/events/summer-camp-2026.jpg",
      cta: { label: "Register Now", href: "https://tinyurl.com/HICCSUMMERCAMP2026", external: true },
    },
    {
      slug: "prayerthon-2026",
      badge: "Prayer",
      title: "Prayerthon — A 6-Hour Prayer Drive",
      excerpt: "Join us for a 6-hour prayer drive at The Heraldome building site — in person, or streaming live across time zones.",
      dateLabel: "Saturday, August 29, 2026",
      timeLabel: "7:00AM (Nigeria / UK) · 10:00AM (UAE) · 1:00AM (USA)",
      location: "The Heraldome Building Site, Along Memphis Close, Atan Offot, Uyo, Akwa Ibom State",
      image: "/images/events/prayerthon-2026.jpg",
      cta: { label: "Join Us Live", href: site.social.telegram.value, external: true },
    },
    {
      slug: "congress-2026",
      badge: "Heralds Congress",
      title: "Heralds Congress 2026 — Unveiling: \"Christ In You\"",
      excerpt: "Unveiling the Heralds Congress 2026 theme, \"Christ In You\" (Col 1:24–28), hosted by Pst. & Pst. (Mrs.) Christosin Olalere.",
      dateLabel: "Wednesday, October 28 – Sunday, November 1, 2026",
      timeLabel: null,
      location: "The Heraldome, Along Memphis Close, Atan Offot, Off Ring Road 1, Uyo, Akwa Ibom State",
      image: "/images/events/congress-2026.jpg",
      cta: { label: "Contact Us For Details", href: "/contact.html", external: false },
    },
  ],
  emptyState: {
...
// ---------------------------------------------------------------------------
// Membership — real journey stages and leadership as supplied by the church.
// ---------------------------------------------------------------------------
export const membership = {
  hero: {
    badge: "Belong",
    heading: "Become Part Of The Family",
    body: "Whether you're visiting for the first time or ready to serve, here's the path from guest to Steward at Heralds.",
    image: "/images/welcome-portrait.jpg",
  },
  journey: {
    badge: "Your Journey",
    heading: "From Guest To Steward",
    body: "Four stages — start by visiting, then grow into the Heralds family.",
    steps: [
      {
        step: "01",
        title: "Guest",
        body: "Visit us and connect with our welcome team — come as you are, no commitment required.",
      },
      {
        step: "02",
        title: "Membership",
        body: "Express interest in joining and take your first step into the Heralds family.",
      },
      {
        step: "03",
        title: "Petra Academy",
        body: "Learn the vision and grow in the Word through Petra Academy, our foundational teaching track.",
      },
      {
        step: "04",
        title: "Steward",
        body: "Step into service — serve in a ministry as a Steward of what God has given you.",
      },
    ],
  },
  value: {
    badge: "Membership",
    heading: "Become A Vital Part Of The Family",
    body: "Membership at Heralds answers your questions about who we are, and shows how you can find your place in the family.",
    bullets: [
      "Understand Heralds' vision, values and way of life",
      "Connect with a discipleship community",
      "Grow toward serving as a Steward, in the ministry that fits you",
    ],
    card: {
      heading: "Start With A Visit",
      body: "Plan your visit and our welcome team will guide you onto the membership path.",
      cta: { label: "Plan Your Visit", href: "/about.html#visit" },
    },
  },
  pastors: {
    badge: "Leadership",
    heading: "Our Pastors",
    body: "Led by pastors committed to raising a family of effective ministers of the Word.",
    list: [
      {
        name: "Pst. & Pst. (Mrs.) Christosin Olalere",
        role: "Host",
        bio: "Hosting the Heralds family in worship and the ministration of the Word.",
      },
      {
        name: "Pst. Godswill Akpan",
        role: "Resident Pastor",
        bio: "Shepherding the day-to-day life of Heralds International Christian Centre, Ibadan.",
      },
    ],
  },
  care: {
    badge: "Care",
    heading: "Pastoral Care & Support",
    body: "Life can be challenging. Church Care watches over the practical and pastoral wellbeing of members and guests navigating personal, relational or spiritual needs — you are not alone.",
    cta: { label: "Explore Church Care", href: "/ministries.html#church-care" },
    secondaryCta: { label: "Contact Us", href: "/contact.html" },
  },
  finalCta: {
    badge: "Next Step",
    heading: "Register Your Visit",
